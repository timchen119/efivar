...
extern int eb_disk_info_from_sysfs(struct disk_info *info, const char * const partition_path);
extern int eb_disk_info_from_path(const char *devpath, struct disk_info *info);
